USE [master]
GO
/****** Object:  Database [cpBeerAndUser]    Script Date: 17/11/2021 11:16:26 ******/
CREATE DATABASE [cpBeerAndUser]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BierenDb', FILENAME = N'S:\Data\cpBeerAndUser.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'BierenDb_log', FILENAME = N'S:\Data\cpBeerAndUser_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
USE [cpBeerAndUser]
GO
/****** Object:  Table [dbo].[tblCPBeer]    Script Date: 17/11/2021 11:16:26 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[tblCPBeer](
	...
	[strBeerName] [nchar](100) NOT NULL,
...
GO
/****** Object:  Table [dbo].[tblCPBrewer]    Script Date: 17/11/2021 11:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblCPBrewer](
	...
	[strBrewerName] [nchar](50) NOT NULL,
	[strBrewerAddress] [nchar](50) NULL,
	[strBrewerZipCode] [nchar](4) NULL,
	[strBrewerCity] [nchar](50) NULL,
...
GO
/****** Object:  Table [dbo].[tblCPKindOfBeer]    Script Date: 17/11/2021 11:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblCPKindOfBeer](
	...
	[strKindOfBeerDescription] [nchar](50) NOT NULL,
...
GO
/****** Object:  Table [dbo].[tblCPUser]    Script Date: 17/11/2021 11:16:26 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[tblCPUser](
	...
	[strFirstName] [nchar](25) NOT NULL,
	[strLastName] [nchar](50) NOT NULL,
	[strEmailAddress] [nchar](100) NOT NULL,
	[dtmBirth] [date] NULL,
