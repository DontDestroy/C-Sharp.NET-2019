USE [master]
GO
/****** Object:  Database [cpADONET]    Script Date: 17/11/2021 11:21:44 ******/
...
USE [cpADONET]
GO
/****** Object:  Table [dbo].[tblCPProduct]    Script Date: 17/11/2021 11:21:44 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tblCPProductCategory]    Script Date: 17/11/2021 11:21:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [PK__tblCPProduct]    Script Date: 17/11/2021 11:21:44 ******/
ALTER TABLE [dbo].[tblCPProduct] ADD  CONSTRAINT [PK__tblCPProduct] PRIMARY KEY NONCLUSTERED 
(
	[intIdProduct] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
ALTER TABLE [dbo].[tblCPProduct]  WITH CHECK ADD  CONSTRAINT [FK_tblCPProduct_tblCPProductCategory] FOREIGN KEY([intProductCategoryId])
REFERENCES [dbo].[tblCPProductCategory] ([intIdProductCategory])
GO
ALTER TABLE [dbo].[tblCPProduct] CHECK CONSTRAINT [FK_tblCPProduct_tblCPProductCategory]
GO
/****** Object:  StoredProcedure [dbo].[tblCPProduct_Insert]    Script Date: 17/11/2021 11:21:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
